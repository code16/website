...
@section('body_class','page-sharp')
@section('content')
    <div class="container mx-auto">
        <header>
            <div class="container">
                <div class="txtcenter plm ptl pbl ">
                    <h1 class="mb1">
                        <strong>Sharp</strong> — a content management framework
                    </h1>
                    <h5 class="mt0">
                        An open-source project by <a href="http://code16.fr">CODE 16</a>, for Laravel 5.4+
                    </h5>
                </div>
            </div>
        </header>
        ...
        <div class="txtcenter mal">
            <a href="https://github.com/code16/sharp" class="btn btn-lien">
                <span class="h4-like">See project and docs on Github</span>
            </a>
        </div>

        <div class="pal h2-like txtcenter">
            <p>
                Sharp intends to provide a clean solution to the following needs:
            </p>
        </div>

        <div class="grid-4 grid-small-2">
            <div class=" pam mbm txtcenter">
                ...
                <p class="h5-like">Create, update or delete any structured data of the project, handling validation and errors.</p>
            </div>
            <div class=" pam mbm txtcenter">
                ...
                <p class="h5-like">Display, search, sort or filter data.</p>
            </div>
            <div class=" pam mbm txtcenter">
                ...
                <p class="h5-like">Execute custom commands on one instance, a selection or all instances.</p>
            </div>
            <div class=" pam mbm txtcenter ">
                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" class="heroicon-shield-lock heroicon heroicons-lg">
                ...
                <p class="h5-like">Handle authentication and authorizations.</p>
            </div>
        </div>


        <div class="pal mtl pt0 h2-like txtcenter">
            <p>
                It is a kind of CMS, built with some rules in mind:
            </p>
        </div>

        <div class="grid-2 grid-small-1">
            <div class="Card pal pt0 mbm txtcenter">
                <div class="h4-like">
                    <div class="Card__rule">#1</div>
                    The public website should not have any knowledge of the CMS.
                </div>
                <p>
                    The CMS is a part of the system, not the center of it.
                    In fact, removing the CMS should not have any effect on the project.
                </p>
            </div>
            <div class="Card pal pt0 mbm txtcenter">
                <div class="h4-like">
                    <div class="Card__rule">#2</div>
                    The CMS should not have any expectations from the persistence layer.
                </div>
                <p>
                    MySQL is cool — but it's not the perfect tool for every problem.
                    And more important, the DB structure has nothing to do with the CMS.
                </p>
            </div>
        </div>
        ...
        <div class="grid-2 grid-small-1">
            <div class="Card pal pt0 mbm txtcenter">
                <div class="h4-like">
                    <div class="Card__rule">#3</div>
                    Content administrators should work with their data and terminology, not CMS terms.
                </div>
                <p>
                    I mean, if the project is about spaceships, space travels and pilots, why would the
                    CMS talk about articles, categories and tags?
                </p>
            </div>
            <div class="Card pal pt0 mbm txtcenter">
                <div class="h4-like">
                    <div class="Card__rule">#4</div>
                    Website developers should not have to work on the front-end development for the CMS.
                </div>
                <p>
                    Yeah. Because life is complicated enough, Sharp takes care of all the responsive / CSS / JS stuff.
                </p>
            </div>
        </div>
        ...
        <div class="pal h2-like txtcenter">
            <p>
                But it's not <em>really</em> a CMS, it's a content management framework: Sharp needs
                to be extended with functional code to work. How?
            </p>
        </div>

        <div class="grid-2 grid-small-2">
            <div class="pam mbm txtcenter">
        ...
        <div class="txtcenter pbl mbl mtl">
            <a href="https://github.com/code16/sharp" class="btn btn-lien">
                <span class="h4-like">See project and docs on Github</span>
            </a>
        </div>
