...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Carousel.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Carousel.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleSlideClick: function handleSlideClick(_ref) {
  ...
  mounted: function mounted() {
    ...
    var onDrag = this.$refs.carousel.onDrag;

    this.$refs.carousel.onDrag = function (e) {
      _this2.prevent = false;

      e.stopImmediatePropagation = function () {
        return _this2.prevent = true;
      };

      onDrag(e);
    };

    this.$el.querySelector('.VueCarousel-wrapper').addEventListener('touchmove', function (e) {
      if (_this2.prevent) {
        e.preventDefault();
      }
    });
    this.$refs.carousel.$watch('dragging', function (dragging) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stack.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stack.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleStackClicked: function handleStackClicked() {
      this.showCarousel = true;
    },
    handleBackdropClicked: function handleBackdropClicked() {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stacker.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stacker.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Carousel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Carousel */ "./source/_assets/js/vue/components/Carousel.vue");
/* harmony import */ var _Stack__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Stack */ "./source/_assets/js/vue/components/Stack.vue");
...
var Carousel = vue__WEBPACK_IMPORTED_MODULE_2__["default"].extend(_Carousel__WEBPACK_IMPORTED_MODULE_0__["default"]);
var Stack = vue__WEBPACK_IMPORTED_MODULE_2__["default"].extend(_Stack__WEBPACK_IMPORTED_MODULE_1__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: {
    breakpoint: {
      type: Number,
  ...
  methods: {
    adjacentImages: function adjacentImages() {
      return _toConsumableArray(this.$el.querySelectorAll('p')).map(function (p) {
        return _toConsumableArray(p.querySelectorAll('img+img'));
      }).filter(function (images) {
        return images.length > 0;
      }).map(function (images) {
        return [images[0].previousElementSibling].concat(_toConsumableArray(images));
      });
    },
    getLegend: function getLegend(image) {
      var nextSibling = image.nextSibling;
      return nextSibling && nextSibling.nodeType === Node.TEXT_NODE ? nextSibling.textContent : '';
    },
    createSlides: function createSlides(images) {
      var _this = this;

      return images.map(function (image) {
        return {
          image: image,
          legend: _this.getLegend(image)
        };
      });
    },
    mount: function mount(Component) {
      ...
      this.stacks = this.stacks.map(function (_ref) {
        var el = _ref.el,
            slides = _ref.slides,
  ...
  mounted: function mounted() {
    ...
    this.stacks = this.adjacentImages().map(function (images) {
      return {
        el: images[0].parentElement,
        slides: _this3.createSlides(images),
        component: new vue__WEBPACK_IMPORTED_MODULE_2__["default"]()
      };
    });
    this.update();
...
/***/ "./source/_assets/js/components/sticky-title.js":
/*!******************************************************!*\
  !*** ./source/_assets/js/components/sticky-title.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ stickyTitle)
/* harmony export */ });
...
function setTransform(el, value) {
  ...
  ['webkit', 'ms', 'Moz', 'O'].forEach(function (vendor) {
    el.style["".concat(vendor, "Transform")] = value;
  });
}
...
function transform(el, _ref) {
  var theta = _ref.theta,
      translateX = _ref.translateX,
      translateY = _ref.translateY;
  setTransform(el, "rotate3d(0,0,1,".concat(theta, "deg) translate3d(").concat(translateX, "px,").concat(translateY, "px, 0)"));
} // dy: distance from scrollY to "starting point" Y (top of the title)


function getTransformData(state, _ref2) {
  var dy = _ref2.dy;
  var d = limit(dy / state.props.duration, 0, 1);
  var anchorX = state.initialRect.width / 2;
  var anchorY = state.initialRect.width / 2 - state.initialRect.height / 2 - state.props.relativeAnchorX; //debugger;
...
function setSticky(el, _ref3) {
  var state = _ref3.state,
      dy = _ref3.dy;

  var _getTransformData = getTransformData(state, {
    dy: dy
  }),
      theta = _getTransformData.theta,
      translateY = _getTransformData.translateY;

  state.isSticky = true;
  el.style.position = 'fixed';
  el.style.top = "".concat(state.initialRect.width / 2 + state.props.paddingTop / 2 + state.props.endOffset, "px");
  transform(el, {
    theta: theta,
    translateX: 0,
...
function handleScroll(el) {
  var _el$_stickyTitleState = el._stickyTitleState,
      initialRect = _el$_stickyTitleState.initialRect,
      container = _el$_stickyTitleState.container,
      ...
      isFirstScroll = _el$_stickyTitleState3 === void 0 ? true : _el$_stickyTitleState3;
  var scrollY = window.pageYOffset;
  var dy = scrollY - (initialRect.y - paddingTop + startOffset);

  if (!isEnabled()) {
    setStatic(el, {
      state: el._stickyTitleState
    });
  ...
  if (dy > duration) {
    if (!!container) {
      if ((!touchTop || isFirstScroll) && scrollY < containerRect.y - paddingTop) {
        if (isSticky) {
          transform(el, getTransformData(el._stickyTitleState, {
            dy: dy
          }));
        }
  ...
  if (!!container) {
    ...
    if ((!touchBottom || isFirstScroll) && scrollY > containerBottom - titleBottom) {
      el.style.position = 'absolute';
      el.style.top = 'auto';
      el.style.bottom = "".concat(initialRect.width / 2, "px");
...
function createPlaceholder(el) {
  ...
  res.setAttribute('style', "display:none;width:".concat(el.offsetWidth, "px;height:").concat(el.offsetHeight, "px"));
...
function updateRects(el) {
  var _el$_stickyTitleState4 = el._stickyTitleState,
      container = _el$_stickyTitleState4.container,
      isFirstScroll = _el$_stickyTitleState4.isFirstScroll,
      idle = _el$_stickyTitleState4.idle;
...
function stickyTitle(options) {
  var el = this.$el;
  el._stickyTitleState = {
    ready: false,
    initialRect: getRect(el),
    props: _objectSpread(_objectSpread({}, defaultProps), options),
  ...
  if (options.container) {
    var container = findAncestor(el, options.container.slice(1));
  ...
  var idle = lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    return el._stickyTitleState.idle = true;
  }, 200);

  el._stickyTitleScrollListener = function () {
    idle();
    updateRects(el);
...
/* harmony import */ var _components_sticky_title__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/sticky-title */ "./source/_assets/js/components/sticky-title.js");
/* harmony import */ var _vue_components_Stacker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vue/components/Stacker */ "./source/_assets/js/vue/components/Stacker.vue");
...
_toConsumableArray(document.querySelectorAll('[data-v-app]')).forEach(function (el) {
  var app = new vue__WEBPACK_IMPORTED_MODULE_3__["default"]({
    components: {
      Stacker: _vue_components_Stacker__WEBPACK_IMPORTED_MODULE_1__["default"]
    }
  });
  app.$mount(el);
});
...
alpinejs__WEBPACK_IMPORTED_MODULE_2__["default"].data('stickyTitle', _components_sticky_title__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _
*/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Carousel.vue?vue&type=template&id=35b88c6d&");


/***/ }),

/***/ "./source/_assets/js/vue/components/Stack.vue?vue&type=template&id=77f4a4cb&":
/*!***********************************************************************************!*\
  !*** ./source/_assets/js/vue/components/Stack.vue?vue&type=template&id=77f4a4cb& ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Stack_vue_vue_type_template_id_77f4a4cb___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Stack_vue_vue_type_template_id_77f4a4cb___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Stack_vue_vue_type_template_id_77f4a4cb___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Stack.vue?vue&type=template&id=77f4a4cb& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stack.vue?vue&type=template&id=77f4a4cb&");


/***/ }),

/***/ "./source/_assets/js/vue/components/Stacker.vue?vue&type=template&id=aa3e5b90&":
/*!*************************************************************************************!*\
  !*** ./source/_assets/js/vue/components/Stacker.vue?vue&type=template&id=aa3e5b90& ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Stacker_vue_vue_type_template_id_aa3e5b90___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Stacker_vue_vue_type_template_id_aa3e5b90___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Stacker_vue_vue_type_template_id_aa3e5b90___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Stacker.vue?vue&type=template&id=aa3e5b90& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stacker.vue?vue&type=template&id=aa3e5b90&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Carousel.vue?vue&type=template&id=35b88c6d&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Carousel.vue?vue&type=template&id=35b88c6d& ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c(
    "carousel",
    {
      ...
      class: _vm.classes,
      attrs: { "per-page": 1, "pagination-enabled": false, speed: _vm.speed },
      on: { pageChange: _vm.handlePageChanged },
    },
    _vm._l(_vm.slides, function (slide, i) {
      return _c(
        ...
        {
          key: i,
          staticClass: "slide relative",
          attrs: { "data-index": i },
          on: { slideClick: _vm.handleSlideClick },
        },
        [
          _c("div", {
            staticClass: "slide-image-container",
            domProps: { innerHTML: _vm._s(slide.image.outerHTML) },
          }),
          _vm._v(" "),
          _c("span", { staticClass: "legend" }, [_vm._v(_vm._s(slide.legend))]),
        ]
      )
    }),
    1
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stack.vue?vue&type=template&id=77f4a4cb&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stack.vue?vue&type=template&id=77f4a4cb& ***!
  \**************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "stack" }, [
    _c("div", {
      staticClass: "stack-top",
      domProps: { innerHTML: _vm._s(_vm.slides[0].image.outerHTML) },
      on: { click: _vm.handleStackClicked },
    }),
    _vm._v(" "),
    _vm.showCarousel
      ? _c(
          "div",
          {
            staticClass: "fixed pin z-30 flex items-center",
            staticStyle: { background: "rgba(0,0,0,.5)" },
            on: { click: _vm.handleBackdropClicked },
          },
          [
            _c(
              "carousel",
              {
                staticClass: "lightbox max-w-full max-h-full",
                attrs: { "per-page": 1 },
              },
              _vm._l(_vm.slides, function (slide, i) {
                return _c(
                  ...
                  [
                    ...
                    _c(
                      "div",
                      {
                        staticClass: "legend leading-normal pl-2",
                        staticStyle: { background: "rgba(0,0,0,.5)" },
                      },
                      [_vm._v(_vm._s(slide.legend))]
                    ),
                  ]
                )
              }),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stacker.vue?vue&type=template&id=aa3e5b90&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./source/_assets/js/vue/components/Stacker.vue?vue&type=template&id=aa3e5b90& ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
