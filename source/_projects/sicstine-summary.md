...
<div class="bg-grey-light pt-4 pb-4 mt-4">
    <div class="text-center">
        <h2>L'administrateur se connecte à Sicstine pour :</h2> 
    </div>
    ...
    <div class="flex mt-4">
        ...
        <div class="w-1/3">
            <div class="text-center">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" class="heroicon-ticket heroicon heroicons-lg">
            ...
            <div class="text-center">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" class="heroicon-target heroicon heroicons-lg">
                    <path class="heroicon-target-background heroicon-component-fill" d="M82 11.58V18h6.42A50 50 0 1 1 82 11.58z"></path>
                    <path class="heroicon-target-stripes heroicon-component-accent heroicon-component-fill" d="M82 11.58V18h6.42A50 50 0 1 1 82 11.58zM50 90a40 40 0 1 0 0-80 40 40 0 0 0 0 80zm0-10a30 30 0 1 1 0-60 30 30 0 0 1 0 60zm0-10a20 20 0 1 0 0-40 20 20 0 0 0 0 40zm0-10a10 10 0 1 1 0-20 10 10 0 0 1 0 20z"></path>
                    <polygon class="heroicon-target-arrow heroicon-component-fill" points="82 10 92 0 92 8 100 8 90 18 82 18"></polygon>
                    <rect class="heroicon-shadows" width="49" height="2" x="50" y="49"></rect>
                    <path class="heroicon-outline" fill-rule="nonzero" d="M92 0v8h8L90 18h-1.58A50 50 0 1 1 82 11.58V10L92 0zm-3 50a38.87 38.87 0 0 0-10.72-26.86L71.9 29.5a30 30 0 1 1-1.41-1.41l6.36-6.38A39 39 0 1 0 89 50zm-5.59-32l-4.43 4.43a40 40 0 1 1-1.41-1.41L82 16.59v-2.37A48 48 0 1 0 85.78 18H83.4zM69.8 28.8a29 29 0 1 0 1.41 1.41l-6.37 6.37a20 20 0 1 1-1.41-1.41l6.37-6.37zm-7.08 7.08a19 19 0 1 0 1.41 1.41l-6.38 6.38a10 10 0 1 1-1.41-1.41l6.38-6.38zm-7.1 7.09a9 9 0 1 0 1.41 1.41l-6.31 6.33a1 1 0 1 1-1.42-1.42l6.33-6.32zM84 15.29l6-6V4.83l-6 6v4.46zm.7.71h4.47l6-6h-4.46l-6 6z"></path>
                </svg>
              </div>
              <div class="ml-4">
...
<div class="bg-grey-light pt-4 pb-4 mt-4">
    <div class="text-center">
        <h2>Les applications se connectent à Sicstine pour :</h2>
        <div class="ml-3 mr-3"> 
            (Un site internet principal, une app mobile, une app facebook, une borne interactive, un site événementiel, ... qui se connectent techniquement à Sicstine via une API)
        </div>
    </div>
    ...
    <div class="flex mt-4">
        <div class="w-1/3">
            <div class="text-center">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" class="heroicon-browser heroicon heroicons-lg">
                        <path class="heroicon-browser-interface-background heroicon-component-fill" d="M0 31h100v55a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V31z"></path>
                        <rect class="heroicon-browser-interface-body heroicon-component-fill" width="56" height="36" x="10" y="48"></rect>
                        <rect class="heroicon-browser-interface-sidebar heroicon-component-fill" width="22" height="36" x="68" y="48"></rect>
                        <rect class="heroicon-browser-interface-top heroicon-component-fill" width="80" height="10" x="10" y="36"></rect>
                        <path class="heroicon-browser-menu-bar heroicon-component-accent heroicon-component-fill" d="M0 14a4 4 0 0 1 4-4h92a4 4 0 0 1 4 4v17H0V14z"></path>
                        <rect class="heroicon-browser-search heroicon-component-fill" width="92" height="4" x="4" y="24"></rect>
                        <path class="heroicon-outline" fill-rule="nonzero" d="M0 30V14a4 4 0 0 1 4-4h92a4 4 0 0 1 4 4v72a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V30zm96-18H4a2 2 0 0 0-2 2v6h16l6-6h18l6 6h50v-6a2 2 0 0 0-2-2zM2 30h96v-8H47.17l-.58-.59L41.17 16H24.83l-5.42 5.41-.58.59H2v8zm0 2v54c0 1.1.9 2 2 2h92a2 2 0 0 0 2-2V32H2zm3-8h91v4H4v-4h1zm90 1H5v2h90v-2zM10 36h80v10H10V36zm1 1v8h78v-8H11zm0 11h55v36H10V48h1zm54 1H11v34h54V49zm3-1h22v36H68V48zm1 1v34h20V49H69zM8 16a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm3 2a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm7-2a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"></path>
                    </svg>
                </div>
                <div class="ml-4">
        ...
        <div class="w-1/3">
            <div class="text-center">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" class="heroicon-cart heroicon heroicons-lg">
        ...
        <div class="w-1/3">
            <div class="text-center">
                ...
                <div class="ml-4">
                    Eenvoyer des informations de comportement à analyser.
                </div>
            </div>
        </div>
    </div>
